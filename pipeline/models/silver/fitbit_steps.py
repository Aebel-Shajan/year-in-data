"""Silver table: fitbit/steps — (date, value) value = step count"""
...
_FILE_RE = re.compile(r"Fitbit/Global Export Data/steps-\d{4}-\d{2}-\d{2}\.json$", re.IGNORECASE)


def fitbit_steps(r2: R2Client, input_key: str, output_key: str, start: date | None = None, end: date | None = None) -> None:
