...
def daily_sleep(r2: R2Client, input_key: str, output_key: str, unit: str, label: str, start: date | None = None, end: date | None = None, dry_run: bool = False) -> None:
    ...
    gold = df.with_columns((pl.col("value") / 60).round(2).alias("value"))
