"""Silver table: fitbit/sleep — (date, value) value = minutes asleep"""
...
_FILE_RE = re.compile(r"Fitbit/Global Export Data/sleep-\d{4}-\d{2}-\d{2}\.json$", re.IGNORECASE)


def fitbit_sleep(r2: R2Client, input_key: str, output_key: str, start: date | None = None, end: date | None = None) -> None:
